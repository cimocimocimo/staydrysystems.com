            ...
            <div class="cart-collaterals">
                ...
                <?php if ( $woocommerce->cart->coupons_enabled() ) { ?>
                    <div class="coupon">
                        ...
                        <input type="text" name="coupon_code"  id="coupon_code" value="" placeholder="<?php _e( 'Enter Coupon', 'captiva' ); ?>"/> 
                        <input type="submit" class="button small expand" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'captiva' ); ?>" />
