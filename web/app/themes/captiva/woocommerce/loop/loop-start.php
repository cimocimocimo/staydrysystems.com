...
<div class="product-wrap">
    <div class="row">
        <?php if ( !empty( $woo_product_grid_count ) ) { ?>
            ...
            <?php } elseif ( isset( $captiva_options['product_grid_count'] ) ) { ?>
                <ul class="products col-xs-product-2 col-sm-product-3 col-md-product-3 col-lg-product-<?php echo $captiva_options['product_grid_count']; ?> <?php echo $product_layout; ?>">
                <?php } else { ?>
