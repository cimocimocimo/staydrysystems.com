...
$j( document ).ready( function() {
    ...
    $j( 'ul#tootlbar_header_top_menu li' ).click( function() {
        if ( $j( this ).attr( "data-value" ) != "" ) {
            ...
            $j.post( root + 'livepreview.php', { cap_header_top: $j( this ).attr( "data-value" ) }, function( data ) {
                location.reload();
            } );
        }
    } );
    ...
    $j( 'ul#tootlbar_woocatalog li' ).click( function() {
        if ( $j( this ).attr( "data-value" ) != "" ) {
            ...
            $j.post( root + 'livepreview.php', { cap_catmode: $j( this ).attr( "data-value" ) }, function( data ) {
                location.reload();
            } );
        }
    } );
    ...
    $j( 'ul#tootlbar_woohideprices li' ).click( function() {
        if ( $j( this ).attr( "data-value" ) != "" ) {
            ...
            $j.post( root + 'livepreview.php', { cap_hideprices: $j( this ).attr( "data-value" ) }, function( data ) {
                location.reload();
            } );
        }
    } );
    ...
    $j( 'ul#tootlbar_pattern li' ).click( function() {
        ...
        if ( $j( this ).attr( "data-value" ) != "no" ) {
            ...
            newSkin = "body.boxed { \
									background-image: url('http://captivabeta.captivate.io/wp-content/uploads/2014/07/" + $j( this ).attr( "data-value" ) + ".png'); \
    ...
    $j( 'ul#tootlbar_background li' ).click( function() {
        ...
        if ( $j( this ).attr( "data-value" ) != "no" ) {
            $j( 'body' ).addClass( 'boxed' );
            newSkin = "body.boxed { \
									background-image: url('http://captivabeta.captivate.io/wp-content/uploads/2014/07/" + $j( this ).attr( "data-value" ) + ".jpg'); \
									background-position: 0px 0px; \
									background-repeat: repeat; \
    ...
    $j( '#tootlbar_colors .color' ).each( function() {
        $j( this ).on( 'click', function() {
			...
			$j.post( root + 'livepreview.php', { cap_skin_color: $j( this ).attr( "data-color" ) }, function( data ) {
                location.reload();
            } );
        } );
    } );
